...
def serve():
    ...
    try:
        ...
        from rpc.tickets_service import TicketsServicer
    ...
    tickets_pb2_grpc.add_TicketsServiceServicer_to_server(TicketsServicer(), server)
    logger.info("✓ TicketsServicer registered")
    
    SERVICE_NAMES = (
        tickets_pb2.DESCRIPTOR.services_by_name['TicketsService'].full_name,
