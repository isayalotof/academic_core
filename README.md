...
## На Windows необходимо установить Docker desktop и git с официальных сайтов
...
Создаем файлик .env в корневой директории, скопировав содержимое env.template через IDE
