...
export default function CreateClassroom() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await classroomService.createClassroom(submitData)
      alert('Аудитория успешно создана!')
      navigate('/admin/classrooms')
    } catch (err: any) {
      setError(err.response?.data?.detail || 'Ошибка при создании аудитории')
    } finally {
      setIsSubmitting(false)
    }
  }
            ...
            <Flex direction="column" gap="16px">
              ...
              <Flex direction="column" gap="8px">
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  />
                  <span style={{ color: '#333' }}>Есть проектор</span>
                </label>
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ color: '#333' }}>Есть доска</span>
                </label>
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <input
                    type="checkbox"
                  ...
                  />
                  <span style={{ color: '#333' }}>Есть компьютеры</span>
                </label>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  />
                  <span style={{ color: '#333' }}>Доступна для маломобильных</span>
                </label>
              </Flex>
